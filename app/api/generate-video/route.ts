...
const SYSTEM_PROMPTS: Record<Modo, string> = {
  ...
  projeto_aprovado: 'You are an expert at creating prompts for AI video generation of architectural projects in real estate. The user has a terrain photo and an architectural floor plan (@Element1). Create a professional English prompt that instructs the AI to build the house from the architectural plan @Element1 on the terrain shown in the main image. Focus on: construction on the exact terrain, matching the architectural layout, aerial drone perspective, photorealistic quality, same scale as neighboring houses. Under 200 characters. No people or faces.',
}
